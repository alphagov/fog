  ...
  module Parsers
    module Compute
      module VcloudDirector
        ...
        class OurToHashDocument < Nokogiri::XML::SAX::Document
          ...
          def end_element(name)
            ...
            elsif last.class == Hash && last.size > 0 && !@value.empty?
              @stack.last[name.to_sym] = { :attributes => last, :value => @value }
            elsif !@value.empty?
          ...
          def start_element(name, attributes = [])
            ...
            until attributes.empty?
              ...
              # parsed attributes is now a Hash of attributes
